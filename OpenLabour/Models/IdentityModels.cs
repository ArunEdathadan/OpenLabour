...
namespace OpenLabour.Models
{
    ...
    public class QualityRating
    {
        ...
        public string RatedOnUserID { get; set; }
        public string RatedByUserID { get; set; }
        public virtual ApplicationUser ApplicationUser { get; set; }
    }

    public class QualityRatingVerification : VerificationInherit
    {
        [Key]
        public int QualityRatingVerificationID { get; set; }

        public int QualityRatingID { get; set; }
        public virtual QualityRating QualityRating { get; set; }
    }

    public class QualityRatingVerificationDocuments : VerificationDocumentsInherit
    {
        [Key]
        public int QualityRatingVerificationSupportDocID { get; set; }

        public int QualityRatingVerificationID { get; set; }
        public virtual QualityRatingVerification QualityRatingVerification { get; set; }
    }
    ...
    #region Organization , Institutions or Companies
    ...
    public class OrganisationVerifications : VerificationInherit
    {
        [Key]
        public int OrganisationVerificationID { get; set; }

        public int OrganisationID { get; set; }
        public virtual Organisation Organisation { get; set; }
    }

    public class OrganisationVerificationDocuments : VerificationDocumentsInherit
    {
        [Key]
        public int OrganisationVerificationSupportDocID { get; set; }

        public int OrganisationVerificationID { get; set; }
        public virtual OrganisationVerifications OrganisationVerifications { get; set; }
    }
    ...
    public class PersonelQualitiesType
    {
        [Key]
        public int PersonelQualityID { get; set; }
        public string QualityName { get; set; }
        /// <summary>
        /// This rating will be used for calculating, total social value regarding particular activity.
        /// </summary>
    ...
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public DbSet<OrganisationVerificationDocuments> OrganisationVerificationDocuments { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<QualityRatingVerification>()
                .HasRequired(x => x.QualityRating)
                .WithMany()
                .HasForeignKey(x => x.QualityRatingID);

            modelBuilder.Entity<QualityRatingVerificationDocuments>()
                .HasRequired(x => x.QualityRatingVerification)
                .WithMany()
                .HasForeignKey(x => x.QualityRatingVerificationID);
            ...
            #region Organization and assets
            modelBuilder.Entity<Organisation>()
               .HasOptional(x => x.OrganisationParent)
               .WithMany()
               .HasForeignKey(x => x.ParentID);

            modelBuilder.Entity<OrganisationVerifications>()
                .HasRequired(x => x.Organisation)
                .WithMany()
                .HasForeignKey(x => x.OrganisationID);

            //modelBuilder.Entity<OrganisationVerificationDocuments>()
            //    .HasRequired(x => x.OrganisationVerifications)
            //    .WithMany()
            //    .HasForeignKey(x => x.OrganisationVerificationSupportDocID);
